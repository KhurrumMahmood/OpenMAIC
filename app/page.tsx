...
function HomePage() {
    ...
    toast.custom(
      (id) => (
        ...
        >
          ...
          <div className="shrink-0 mt-1 text-xs font-medium text-amber-500 dark:text-amber-500/70 tracking-wide">
  ...
  return (
    <div className="min-h-[100dvh] w-full bg-gradient-to-b from-neutral-50 to-neutral-100/80 dark:from-[#0a0a0f] dark:to-[#0d0d14] flex flex-col items-center p-4 pt-16 md:p-8 md:pt-16 overflow-x-hidden">
      {/* ═══ Top-right pill (unchanged) ═══ */}
      <div
        ref={toolbarRef}
        className="fixed top-4 right-4 z-50 flex items-center gap-1 bg-white/70 dark:bg-white/[0.06] backdrop-blur-xl px-2 py-1.5 rounded-full border border-gray-200/50 dark:border-white/[0.08] shadow-sm"
      >
        {/* Language Selector */}
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div
          className="absolute top-0 left-1/4 w-96 h-96 bg-indigo-500/5 rounded-full blur-3xl animate-pulse"
          style={{ animationDuration: '4s' }}
        />
        <div
          className="absolute bottom-0 right-1/4 w-96 h-96 bg-indigo-500/5 rounded-full blur-3xl animate-pulse"
      ...
      >
        ...
        <motion.div
          ...
          className="w-full"
        >
          <div className="w-full rounded-2xl border border-border/60 bg-white/90 dark:bg-white/[0.04] backdrop-blur-xl shadow-xl shadow-black/[0.03] dark:shadow-black/20 transition-shadow focus-within:shadow-2xl focus-within:shadow-indigo-500/[0.06]">
      ...
      {!open && (
        ...
        >
          <div className="shrink-0 relative">
            <div className="size-8 rounded-full overflow-hidden ring-[1.5px] ring-border/30 group-hover:ring-indigo-400/60 dark:group-hover:ring-indigo-400/40 transition-all duration-300">
          ...
          >
            <div className="rounded-2xl bg-white/95 dark:bg-slate-800/95 backdrop-blur-sm ring-1 ring-black/[0.04] dark:ring-white/[0.06] shadow-[0_1px_8px_-2px_rgba(0,0,0,0.06)] dark:shadow-[0_1px_8px_-2px_rgba(0,0,0,0.3)] px-2.5 py-2">
              ...
              >
                ...
                >
                  <div className="size-8 rounded-full overflow-hidden ring-[1.5px] ring-indigo-300/70 dark:ring-indigo-500/40 transition-all duration-300">
                    <img src={avatar} alt="" className="size-full object-cover" />
                  </div>
                  <motion.div
                    initial={{ scale: 0 }}
                ...
                <div className="flex-1 min-w-0">
                  {editingName ? (
                    <div className="flex items-center gap-1.5" onClick={(e) => e.stopPropagation()}>
                      ...
                      <button
                        onClick={commitName}
                        className="shrink-0 size-5 rounded flex items-center justify-center text-indigo-500 hover:bg-indigo-100 dark:hover:bg-indigo-900/30"
                      >
              ...
              <div className="pt-2" onClick={(e) => e.stopPropagation()}>
                        ...
                        {AVATAR_OPTIONS.map((url) => (
                          <button
                            ...
                            className={cn(
                              ...
                              avatar === url
                                ? 'ring-2 ring-indigo-400 dark:ring-indigo-500 ring-offset-0'
                        ...
                        <label
                          className={cn(
                            ...
                            isCustomAvatar(avatar)
                              ? 'ring-2 ring-indigo-400 dark:ring-indigo-500 ring-offset-0 border-indigo-300 dark:border-indigo-600 bg-indigo-50 dark:bg-indigo-900/30'
                ...
                <UITextarea
                  ...
                  maxLength={200}
                  rows={2}
                  className="resize-none border-border/40 bg-transparent min-h-[72px] !text-[13px] !leading-relaxed placeholder:!text-xs placeholder:!leading-relaxed focus-visible:ring-1 focus-visible:ring-border/60"
                />
              </div>
            </div>
          </motion.div>
  ...
  return (
    <div className="group cursor-pointer" onClick={confirmingDelete ? undefined : onClick}>
      ...
      >
        {slide && thumbWidth > 0 ? (
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="size-12 rounded-2xl bg-gradient-to-br from-indigo-100 to-blue-100 dark:from-indigo-900/30 dark:to-blue-900/30 flex items-center justify-center">
      ...
      <div className="mt-2.5 px-1 flex items-center gap-2">
        <span className="shrink-0 inline-flex items-center rounded-full bg-indigo-100 dark:bg-indigo-900/30 px-2 py-0.5 text-xs font-medium text-indigo-600 dark:text-indigo-400">
