      ...
      <TooltipTrigger asChild>
        <button
          ...
          className={cn(
            ...
            sizeClasses,
            active
              ? 'bg-indigo-500/90 dark:bg-indigo-600/80 text-white shadow-[0_0_12px_rgba(99,102,241,0.45)] dark:shadow-[0_0_12px_rgba(99,102,241,0.3)]'
        ...
        >
          ...
          {isRecording && (
            <span
              className="absolute inset-[-4px] rounded-[10px] border border-indigo-400/40 dark:border-indigo-400/25"
              style={{
