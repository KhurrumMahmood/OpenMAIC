  ...
  return (
    <Card className="p-5 !gap-0 shadow-xl border-muted/40 backdrop-blur-xl bg-white/80 dark:bg-slate-900/80">
      ...
      <div className="flex items-center gap-3.5">
        ...
        >
          <div className="size-11 rounded-full bg-gray-50 dark:bg-gray-800 overflow-hidden ring-2 ring-indigo-300/50 dark:ring-indigo-600/40 group-hover/avatar:ring-indigo-400 dark:group-hover/avatar:ring-indigo-500 transition-all">
        ...
        <div className="flex-1 min-w-0">
          {editingName ? (
            <div className="flex items-center gap-1.5">
              <input
                ...
                className="flex-1 min-w-0 h-7 bg-transparent border-b-2 border-indigo-400 dark:border-indigo-500 text-sm font-semibold text-foreground outline-none placeholder:text-muted-foreground/40"
              />
              <button
                onClick={commitName}
                className="shrink-0 size-6 rounded-md flex items-center justify-center text-indigo-500 hover:bg-indigo-100 dark:hover:bg-indigo-900/30 transition-colors"
              >
          ...
          <p className="text-xs text-muted-foreground/50 mt-0.5">{t('profile.avatarHint')}</p>
        </div>
      </div>
              ...
              <label
                ...
                className={cn(
                  ...
                  isCustomAvatar(avatar)
                    ? 'ring-2 ring-indigo-400 dark:ring-indigo-500 ring-offset-1 ring-offset-white dark:ring-offset-slate-900 border-indigo-300 dark:border-indigo-600 bg-indigo-50 dark:bg-indigo-900/30'
